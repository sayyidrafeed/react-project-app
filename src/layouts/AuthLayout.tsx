...
const AuthLayout: React.FC<AuthLayoutProps> = ({ children, title, subtitle }) => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-8 sm:py-12 relative overflow-hidden bg-gradient-to-br from-upn-green via-upn-green/90 to-upn-green/80 dark:from-dark-bg dark:via-dark-surface dark:to-dark-bg">
            ...
            {/* Main content card */}
            <div className="max-w-md w-full space-y-6 sm:space-y-8 bg-white dark:bg-dark-surface p-6 sm:p-10 rounded-2xl shadow-2xl relative z-10 border border-white/20 dark:border-dark-border">
                <div className="text-center">
                    ...
                    <p className="text-sm sm:text-base text-slate-600 dark:text-dark-text-muted font-medium tracking-wide border-t border-slate-100 dark:border-dark-border pt-3 uppercase">
                        Sistem Informasi <span className="text-upn-gold font-bold">PATRIBERA 2025</span>
                    </p>
                    {title && (
                        <h2 className="mt-4 text-xl sm:text-2xl font-bold text-slate-800 dark:text-dark-text">
                            {title}
                        </h2>
                    )}
                    {subtitle && (
            ...
            <div className="absolute bottom-4 left-0 right-0 text-center z-10">
                <p className="text-xs text-white/60 dark:text-dark-text-muted">
