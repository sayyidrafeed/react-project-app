        ...
        >
            ...
            <div className="mb-6 sm:mb-8">
                <div className="flex items-center justify-between mb-2">
                    <span className="text-xs sm:text-sm font-semibold text-slate-600 dark:text-dark-text-muted">
                        Langkah {currentStep} dari {totalSteps}
                    </span>
                    <span className="text-xs sm:text-sm font-bold text-upn-green dark:text-upn-gold">
                        {Math.round(progress)}%
                    </span>
                </div>
            ...
            <div className="flex gap-3 mt-6 sm:mt-8">
                {currentStep > 1 && (
                    <button
                        onClick={prevStep}
                        className="flex-1 py-3 px-4 border-2 border-slate-200 dark:border-dark-border rounded-xl font-semibold text-slate-600 dark:text-dark-text-muted hover:bg-slate-50 dark:hover:bg-dark-border transition-all flex items-center justify-center gap-2"
                    >
                        <ArrowLeft size={18} />
                        <span>Kembali</span>
                    </button>
    ...
    <div className="space-y-4 sm:space-y-5">
        <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-upn-green/10 rounded-lg flex items-center justify-center">
                <User className="text-upn-green dark:text-upn-gold" size={20} />
            </div>
            <div>
                <h3 className="text-lg font-bold text-slate-800 dark:text-dark-text">Informasi Pribadi</h3>
                <p className="text-xs text-slate-500 dark:text-dark-text-muted">Masukkan data diri Anda</p>
            </div>
        </div>
...
const Step2AcademicInfo: React.FC<{
    ...
    <div className="space-y-4 sm:space-y-5">
        <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-upn-green/10 rounded-lg flex items-center justify-center">
                <GraduationCap className="text-upn-green dark:text-upn-gold" size={20} />
            </div>
            <div>
                <h3 className="text-lg font-bold text-slate-800 dark:text-dark-text">Informasi Akademik</h3>
                <p className="text-xs text-slate-500 dark:text-dark-text-muted">Data program studi Anda</p>
            </div>
        </div>
...
const Step3Interests: React.FC<{
    ...
    <div className="space-y-4 sm:space-y-5">
        <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-upn-green/10 rounded-lg flex items-center justify-center">
                <Heart className="text-upn-green dark:text-upn-gold" size={20} />
            </div>
            <div>
                <h3 className="text-lg font-bold text-slate-800 dark:text-dark-text">Minat & Hobi</h3>
                <p className="text-xs text-slate-500 dark:text-dark-text-muted">Pilih minat Anda (boleh lebih dari satu)</p>
            </div>
        </div>
                ...
                return (
                    <button
                        ...
                        className={`px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-semibold transition-all border-2 ${isSelected
                            ...
                            : 'bg-white dark:bg-dark-surface text-slate-600 dark:text-dark-text-muted border-slate-200 dark:border-dark-border hover:border-upn-green hover:text-upn-green dark:hover:text-upn-gold'
                            }`}
                    >
                        {isSelected ? (
...
const Step4SocialConnect: React.FC<{
    ...
    <div className="space-y-4 sm:space-y-5">
        <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 bg-upn-green/10 rounded-lg flex items-center justify-center">
                <Share2 className="text-upn-green dark:text-upn-gold" size={20} />
            </div>
            <div>
                <h3 className="text-lg font-bold text-slate-800 dark:text-dark-text">Koneksi Sosial</h3>
                <p className="text-xs text-slate-500 dark:text-dark-text-muted">Opsional: Hubungkan akun media sosial</p>
            </div>
        </div>
        ...
        <div>
            ...
            <div className="relative">
                ...
                />
                <span className="absolute left-3 top-3 sm:top-3.5 text-slate-400 dark:text-dark-text-muted">@</span>
            </div>
        </div>
        ...
        <div className="p-3 sm:p-4 bg-upn-gold/10 dark:bg-upn-gold/5 border border-upn-gold/20 rounded-lg">
